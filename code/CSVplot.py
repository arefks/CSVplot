...
Path = r"C:\Users\aswen\Desktop\validation"
...
for dd,data in enumerate(All_Data):
    for feature in features_to_compare:
        ...
        if not Data_of_selected_feature.empty:
            ...
            ax.legend_.remove()
            ax
            ax.set_xticklabels(ax.get_xticklabels(), rotation=40, weight='bold')
# =============================================================================
#             for label, color in zip(ax.get_xticklabels(), legend_colors):
#                 label.set_color(color)
# =============================================================================
            ax.set_xlabel('')
            ax.set_title(All_type[dd],weight='bold')
            y_label = ax.set_ylabel(ax.get_ylabel(), fontweight='bold')
...
sns.set(font='Times New Roman', font_scale=0.7,palette= "Set2",)
...
plt.title('Species Distribution', weight='bold').set_fontsize('9')
...
plt.title('Field Strength Distribution (T)', weight='bold').set_fontsize('9')
...
plt.title('Sequence Type Distribution', weight='bold').set_fontsize('9')
...
plt.title('Data Format Distribution', weight='bold').set_fontsize('9')
